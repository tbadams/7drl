...
def main_menu(con):
    ...
    while not libtcod.console_is_window_closed():
        ...
        con.set_key_color(0, libtcod.light_yellow)
        libtcod.console_print(0, SCREEN_WIDTH/2, SCREEN_HEIGHT/2-4, libtcod.BKGND_NONE, 'TOMBS OF THE ANCIENT KINGS')
        libtcod.console_print(0, SCREEN_WIDTH/2, SCREEN_HEIGHT-2, libtcod.BKGND_NONE, 'By Jotaf')
